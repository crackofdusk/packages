 ...
 */
static char font[] = "Droid Sans Mono Slashed:pixelsize=16:antialias=true:autohint=false:hinting=true:hintstyle=hintfull:rgba=rgb";
...
static Shortcut shortcuts[] = {
	...
	{ ShiftMask|ControlMask,XK_plus,        xzoom,          {.f = +1} },
